...
<div
  class="flex justify-center items-center w-full h-[600px] bg-[linear-gradient(to_bottom,rgba(0,0,0,0.2),rgba(0,0,0,0.9)_90%),url({{ index .items.banner "image" }})] bg-cover bg-no-repeat bg-center bg-origin-border bg-clip-border bg-local p-2"
>
  <div
